...
public class Progress {
    ...
    /**
     * Updates the progress for a given category by adding the specified progress value to the
     * current progress. If the category is not yet tracked, it adds the category with the specified progress.
    ...
    /**
     * Updates the progress for a given lesson by adding the specified progress value to the
     * current progress. If the lesson is not yet tracked, it adds the lesson with the specified progress.
